...
var handleSlimScroll = function () {
	...
	$(document).on('click', '.sidebar .nav > .has-sub > a', function () {
        ...
        if(e.is(":hidden")){  
			...
			$(this).find("b").addClass("fa fa-angle-up");
		} else{
			$(this).find("b").addClass("caret");
			$(this).find("b").removeClass("fa fa-angle-up");
			e.hide();
		}
	}),
	...
	$(document).bind("click touchstart", function (a) {
		...
		a.isPropagationStopped() || !0 === e || ($("#page-container").hasClass("page-sidebar-toggled") && (e = !0, $("#page-container").removeClass("page-sidebar-toggled")), $(window).width() <= 767 && $("#page-container").hasClass("page-right-sidebar-toggled") && (e = !0, $("#page-container").removeClass("page-right-sidebar-toggled")))
	}),
	$("[data-click=right-sidebar-toggled]").click(function (a) {
		...
		$("#page-container").hasClass(t) ? $("#page-container").removeClass(t) : !0 !== e ? $("#page-container").addClass(t) : e = !1,
		$(window).width() < 480 && $("#page-container").removeClass("page-sidebar-toggled"),
		$(window).trigger("resize")
	}),
	$("[data-click=sidebar-toggled]").click(function (a) {
		a.stopPropagation();
		$("#page-container").hasClass("page-sidebar-toggled") ? $("#page-container").removeClass("page-sidebar-toggled") : !0 !== e ? $("#page-container").addClass("page-sidebar-toggled") : e = !1,
		$(window).width() < 480 && $("#page-container").removeClass("page-right-sidebar-toggled")
	})
}, handleSidebarMinify = function () {
	$("[data-click=sidebar-minify]").click(function (e) {
        if($(this).find("i").hasClass("fa-dedent")){  
            $(this).find("i").removeClass("fa-dedent");
            $(this).find("i").addClass("fa-indent");
        } else{
            $(this).find("i").removeClass("fa-indent");
            $(this).find("i").addClass("fa-dedent");
        } 
		e.preventDefault();
		$('#sidebar [data-scrollbar="true"]').css("margin-top", "0"),
		$('#sidebar [data-scrollbar="true"]').removeAttr("data-init"),
		$("#sidebar [data-scrollbar=true]").stop(),
		$("#page-container").hasClass("page-sidebar-minified") ? ($("#page-container").removeClass("page-sidebar-minified"), $("#page-container").hasClass("page-sidebar-fixed") ? (0 !== $("#sidebar .slimScrollDiv").length && ($('#sidebar [data-scrollbar="true"]').slimScroll({
						destroy: !0
	...
	$(document).on("click", "[data-click=panel-expand]", function (e) {
		...
		if ($("body").hasClass("panel-expand") && $(a).hasClass("panel-expand"))
			$("body, .panel").removeClass("panel-expand"), $(".panel").removeAttr("style"), $(t).removeAttr("style");
			...
			$.when($(".panel").parent('[class*="col-"]').each(function () {
					...
					e && $.each(e, function (e, a) {
						...
						if (0 !== $(t).length) {
							...
							$(t).remove(),
							$(i).append(n),
							$('[data-sortable-id="' + a.id + '"]').attr("data-init", "true")
						}
					}),
					t++
				})).done(function () {
	...
	function a(e, a) {
		...
		case "prev":
			var l = -i;
			l <= n ? ($(t).removeClass("overflow-left"), s = 0) : s = l - n + 80,
	...
	function e(e, a) {
		...
		case "prev":
			var l = -i;
			l <= n ? ($(t).find(".menu-control.menu-control-left").removeClass("show"), s = 0) : s = l - n + 88,
			$(t).animate({
				marginLeft: "-" + s + "px"
			}, 150, function () {
	...
	function a() {
		...
		o != s && s >= n ? $(e).find(".menu-control.menu-control-right").addClass("show") : $(e).find(".menu-control.menu-control-right").removeClass("show"),
		o >= n && s >= n ? $(e).find(".menu-control.menu-control-left").addClass("show") : $(e).find(".menu-control.menu-control-left").removeClass("show")
	}
